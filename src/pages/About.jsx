...
export default function About() {
  return (
    <section className=' bg-cyan-50'>
      ...
      <div className='text-center px-5 font-serif text-lg'>
       <h1 className='mb-8'>Hi, I’m Raje Quyyum, a developer with a passion for [something unique about your work or approach]. With [X] years of experience, I specialize in [key skills or services you offer, e.g., web design, content creation, app development, etc.], blending creativity with problem-solving to create work that resonates.</h1>
